		...
		<div class="info-livro">			
			...
			<div class="final">
				...
				<div class="detalhe-qtd">
					...
					if(isset($_SESSION["nome_utilizador"])) {				
						?>
						<form action="adicionar-wishlist.php" method="post" >
							<input type="hidden" name="id_livro" value="<?php echo $_GET['livro'];?>">
							
							<div class="login-add2"><i class="fa fa-heart" aria-hidden="true"></i></div><input type="submit" value="Add to Wishlist" class="add-to">			
						</form>
					<?php	} ?>
